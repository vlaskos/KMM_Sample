...
__attribute__((swift_name("SharedService")))
@interface SharedSharedService : SharedBase
...
*/
- (void)fetchUsersWithCompletionHandler:(void (^)(NSArray<SharedGitUser *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchUsers(completionHandler:)")));
- (NSArray<SharedGitUser *> *)getUsers __attribute__((swift_name("getUsers()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CacheUser")))
@interface SharedCacheUser : SharedBase <SharedLibrary_baseRealmObject>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithId:(int32_t)id login:(NSString *)login avatarURL:(NSString *)avatarURL url:(NSString *)url __attribute__((swift_name("init(id:login:avatarURL:url:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCacheUserCompanion *companion __attribute__((swift_name("companion")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString *avatarURL __attribute__((swift_name("avatarURL")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CacheUser.Companion")))
@interface SharedCacheUserCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCacheUserCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GitUser")))
@interface SharedGitUser : SharedBase
- (instancetype)initWithId:(int32_t)id url:(NSString *)url login:(NSString *)login avatarURL:(NSString *)avatarURL __attribute__((swift_name("init(id:url:login:avatarURL:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedGitUserCompanion *companion __attribute__((swift_name("companion")));
- (SharedGitUser *)doCopyId:(int32_t)id url:(NSString *)url login:(NSString *)login avatarURL:(NSString *)avatarURL __attribute__((swift_name("doCopy(id:url:login:avatarURL:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GitUser.Companion")))
@interface SharedGitUserCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedGitUserCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("DatabaseService")))
@protocol SharedDatabaseService
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)saveUsers:(NSArray<SharedGitUser *> *)users completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("save(users:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DatabaseServiceImp")))
@interface SharedDatabaseServiceImp : SharedBase <SharedDatabaseService>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkServiceImp")))
@interface SharedNetworkServiceImp : SharedBase <SharedNetworkService>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)fetchUsersWithCompletionHandler:(void (^)(NSArray<SharedGitUser *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchUsers(completionHandler:)")));
- (NSArray<SharedGitUser *> *)getStaticUsers __attribute__((swift_name("getStaticUsers()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UserServiceImp")))
@interface SharedUserServiceImp : SharedBase <SharedUserService>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
